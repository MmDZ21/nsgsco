      ...
      <div className="bg-gray-800 rounded-b-lg py-6">
        <form className="mt-6" onSubmit={(e) => handleSubmit(e)}>
          <div className="relative flex gap-2 right-dir">
            <input
              className="right-dir appearance-none bg-gray-800 border-2 pr-4 border-gray-600 shadow-sm focus:shadow-md focus:border-nsgsco focus:placeholder-gray-600  transition  rounded-md w-3/4 py-3 text-gray-300 leading-tight focus:outline-none focus:ring-gray-600 focus:shadow-outline"
              id="title"
              type="text"
              placeholder="عنوان"
            ...
            />
            <input
              className="right-dir appearance-none text-xs md:text-sm bg-gray-800 border-2 pr-4 border-gray-600 shadow-sm focus:shadow-md focus:border-nsgsco focus:placeholder-gray-600  transition  rounded-md w-1/4 py-3 text-gray-300 leading-tight focus:outline-none focus:ring-gray-600 focus:shadow-outline"
              id="receiver"
              type="text"
