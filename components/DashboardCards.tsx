...
const DashboardCards = (props: Route) => {
  return (
    <Link href={props.link} className="w-full md:w-4/12" key={props.title}>
      <div className="p-2">
        <div className="rounded-3xl p-4 bg-gray-700 bg-opacity-60 hover:bg-nsgsco hover:scale-105 shadow-md hover:shadow-[#102524] cursor-pointer transition ease-in-out duration-300">
